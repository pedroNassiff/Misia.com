...
@section('content')
<section class="first-section section-login">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header g-medium">{{ __('INGRESAR') }}</div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 offset-md-4">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label h-condensed" for="remember">
                                            {{ __('Recordarme') }}
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    ...
                                    @if (Route::has('password.request'))
                                        <a class="btn btn-link h-condensed" href="{{ route('password.request') }}">
